    ...
    <div class="bg-white rounded-lg shadow-lg w-1/3 p-6">
        ...
        <form id="paymentForm" action="{{ route('recharge.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="paymentReceipt" class="form-control" id="paymentReceipt" accept=".jpg,.jpeg,.png,.pdf">
            </div>
            <div class="mb-4">
                <label for="comment" class="block text-gray-700">Comment/Message</label>
                <textarea name="comment" class="form-control" id="comment" rows="3" placeholder="Enter your comment"></textarea>
            </div>
            <div class="mb-4">
